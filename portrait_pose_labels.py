...
POSE_LABELS = {
    ...
    "Ice Climbers": {"a": "Nana Above", "b": "Char Select Portrait - Standing"},
    ...
    "Luigi": {"a": "Bashful", "b": "Char Select Portrait - Hat Tip"},
    "Mario": {"a": "Victory Hand", "b": "Char Select Portrait - Jumping"},
    "Marth": {"a": "Wide Stance", "b": "Char Select Portrait - Narrow Stance"},
    ...
    "Peach": {"a": "Heart Hands", "b": "Char Select Portrait - Standing"},
    ...
    "Samus": {"a": "Metroid 2 Box Art", "b": "Char Select Portrait - Lock On"},
