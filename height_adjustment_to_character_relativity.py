...
POSE_SCALE = { # the comment at the side are the original scaling, matching all chars to donkey kong's portrait height
    "Bowser": {"00a": 0.80, "00b": 1.0},  # {"00a": 0.9336, "00b": 1.0}
    "Captain Falcon": {"00a": 0.65, "00b": 0.65},  # {"00a": 0.7143, "00b": 0.7162}
    ...
    "Fox": {"00a": 0.60, "00b": 0.60},  # {"00a": 0.7153, "00b": 0.8529}
    "Ganondorf": {"00a": 0.7430, "00b": 0.6930},  # {"00a": 0.7430, "00b": 0.8640}
    "Ice Climbers": {"00a": 0.6031, "00b": 0.75},  # {"00a": 0.8762, "00b": 1.0}
    "Jigglypuff": {"00a": 0.6, "00b": 0.55},  # {"00a": 1.0, "00b": 1.0}
    "Kirby": {"00a": 0.58, "00b": 0.58},  # {"00a": 1.0, "00b": 1.0}
    "Link": {"00a": 0.8180, "00b": 0.7983},  # {"00a": 0.8880, "00b": 0.8683}
    "Luigi": {"00a": 0.5546, "00b": 0.5397},  # {"00a": 0.7246, "00b": 0.8097}
    "Mario": {"00a": 0.5238, "00b": 0.5253},  # {"00a": 0.7138, "00b": 0.7153}
    "Marth": {"00a": 0.8022, "00b": 0.6962},  # {"00a": 0.8122, "00b": 0.7062}
    "Mewtwo": {"00a": 0.7841, "00b": 0.6900},  # {"00a": 0.8041, "00b": 0.7100}
    ...
    "Pichu": {"00a": 0.3353, "00b": 0.2622},  # {"00a": 0.9353, "00b": 0.8522}
    "Pikachu": {"00a": 0.6666, "00b": 0.6094},  # {"00a": 1.0, "00b": 0.8294}
    "Roy": {"00a": 0.6704, "00b": 0.88},  # {"00a": 0.7104, "00b": 1.0}
    "Samus": {"00a": 0.7752, "00b": 0.7001},  # {"00a": 0.7752, "00b": 0.7301}
    "Sheik": {"00a": 0.6553, "00b": 0.6084},  # {"00a": 0.7153, "00b": 0.8084}
    "Yoshi": {"00a": 0.5903, "00b": 0.5162},  # {"00a": 0.7903, "00b": 0.7162}
    "Young Link": {"00a": 0.4287, "00b": 0.4500},  # {"00a": 0.7187, "00b": 0.8591}
    "Zelda": {"00a": 0.6553, "00b": 0.6519},  # {"00a": 0.7153, "00b": 0.7119}
}
