...
def main() -> None:
    ...
    doubles_top_3 = [
        doubles_team(1, "Bowser", "Fox", pose_1="a", team_color="red", tag_1="Acme Gaming | Bowser Player", tag_2="Acme Gaming | Fox Player"),
    ...
    doubles_top_4 = [
        doubles_team(1, "Bowser", "Bowser", pose_1="a", pose_2="a", team_color="red", tag_1="Acme Gaming | Very Very Long Bowser Player", tag_2="Acme Gaming | Captain Falcon Player"),
    ...
    singles_top_3 = [
        singles_entrant(1, "Bowser", pose="a", tag="Acme Gaming | Bowser Player"),
