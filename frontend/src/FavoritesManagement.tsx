...
export default function FavoritesManagement({ favorites, renderCount, onChange, onBack }: { favorites: FavoritesData; renderCount: number | null; onChange: (favorites: FavoritesData) => void; onBack: () => void }) {
  ...
  return <main className="page-shell"><header className="site-header"><div><h1>Favorites management</h1><p className="lede">Edit your reusable singles entrants and doubles teams. Everything stays in this browser until you export it.</p></div><button type="button" onClick={onBack}>Back to podium maker</button></header>
